...
const { registerAssessmentRoutes } = require('./pipeline-assessment');
...
/* The assessment lifecycle routes (validation, report, return) live in a
   sibling file so neither passes five hundred lines; they mount on this same
   router, so there is one router and one base path. */
