 ...
 * `owner` names who closes the gap when the check is not held — one of the
 * closed vocabulary in `gaps.js` (the bank, the sponsor, the NDA, the Fund,
...
const REQUIREMENTS = Object.freeze([
  ...
  { id: 'climate_rationale', owner: 'dfcc', cycle: 2, label: 'Climate rationale — baseline and counterfactual stated', clause: 'Concept note B.1, B.2',
  ...
  { id: 'results_area', owner: 'dfcc', cycle: 2, label: 'Results area and stream named', clause: 'GCF results areas',
    remedy: 'Choose one of the eight results areas.', check: p => (has(p.resultsArea) && has(p.stream) ? HELD : MISSING) },
  { id: 'ndc_alignment', owner: 'dfcc', cycle: 2, label: 'NDC 3.0 sector target cited', clause: 'Country ownership — alignment with the NDC',
  ...
  { id: 'taxonomy', owner: 'dfcc', cycle: 2, label: 'Sri Lanka taxonomy band', clause: 'SLGFT',
    remedy: 'Record the SLGFT band the activity falls in.', check: p => (p.taxonomy && has(p.taxonomy.band) ? HELD : MISSING) },
  { id: 'indicative_cost', owner: 'dfcc', cycle: 2, label: 'Indicative cost and GCF ask', clause: 'Concept note C',
  ...
  { id: 'selection_reason', owner: 'dfcc', cycle: 3, label: 'Why this project — the selection reasoning', clause: 'Lot 2 — the two concepts defended',
    remedy: 'Write the reason this project is put forward.', check: p => (has(p.selectionReason) ? HELD : MISSING) },
  { id: 'impact_figure', owner: 'sponsor', cycle: 3, label: 'Impact figure with its evidence tier', clause: 'Concept note B.3; IRMF core indicators 1 and 2',
  ...
  { id: 'barriers', owner: 'dfcc', cycle: 3, label: 'Barriers to commercial finance named', clause: 'Concept note B.2 — why GCF',
  ...
  { id: 'viability', owner: 'dfcc', cycle: 3, label: 'Viability with and without GCF support', clause: 'Efficiency and effectiveness — minimum concessionality',
  ...
  { id: 'ess_category', owner: 'dfcc', cycle: 3, label: 'Environmental and social risk category', clause: 'GCF Environmental and Social Policy',
    remedy: 'Categorise the project A, B, C or I-1 to I-3.', check: p => (has(p.essCategory) ? HELD : MISSING) },
  { id: 'executing_entity', owner: 'sponsor', cycle: 3, label: 'Executing entity named', clause: 'Concept note A; funding proposal A',
    remedy: 'Name the executing entity and its track record.', check: p => (p.executingEntity && has(p.executingEntity.name) ? HELD : MISSING) },
  { id: 'nda_informed', owner: 'dfcc', cycle: 3, label: 'NDA informed of the concept', clause: 'Sri Lanka NDA Operation Manual; concept note A',
  ...
  { id: 'feasibility', owner: 'sponsor', cycle: 4, label: 'Feasibility study', clause: 'Funding proposal annex — feasibility study',
    remedy: 'Attach the feasibility study reference.', check: p => doc(p, 'feasibility_study') },
  { id: 'financial_model', owner: 'sponsor', cycle: 4, label: 'Economic and financial analysis with the financial model', clause: 'Funding proposal annex — economic and financial analysis',
  ...
  { id: 'safeguards_docs', owner: 'sponsor', cycle: 4, label: 'Safeguards documents for the category', clause: 'GCF Environmental and Social Policy — ESIA/ESMP (B), ESAP (C)',
  ...
  { id: 'gender', owner: 'gender_specialist', cycle: 4, label: 'Gender assessment and action plan', clause: 'GCF Gender Policy — assessment with the proposal, action plan at preparation',
  ...
  { id: 'grm', owner: 'sponsor', cycle: 4, label: 'Grievance redress mechanism', clause: 'GCF Environmental and Social Policy',
    remedy: 'Record the project-level grievance mechanism.', check: p => docStatus(p.safeguards && p.safeguards.grm) },
  { id: 'cofinancing', owner: 'co_financiers', cycle: 4, label: 'Co-financiers named, each committed or evidenced by letter', clause: 'Funding proposal annex — co-financing commitment letters',
  ...
  { id: 'fp_submitted', owner: 'dfcc', cycle: 5, label: 'Funding proposal submitted', clause: 'Project cycle stage 4',
    remedy: 'Record the submission date.', check: p => date(p, 'fpSubmitted') },
  { id: 'nda_issued', owner: 'nda', cycle: 5, label: 'NDA no-objection letter issued', clause: 'GCF no-objection procedure',
  ...
  { id: 'board_decision', owner: 'fund', cycle: 7, label: 'Board decision recorded', clause: 'Project cycle stage 6',
    remedy: 'Record the decision date.', check: p => date(p, 'boardDecision') },
  { id: 'faa_signed', owner: 'fund', cycle: 7, label: 'Funded Activity Agreement signed', clause: 'Project cycle stage 7',
    remedy: 'Record the signing date.', check: p => date(p, 'faaSigned') },
  { id: 'faa_effective', owner: 'fund', cycle: 8, label: 'FAA effective', clause: 'Project cycle stage 7',
