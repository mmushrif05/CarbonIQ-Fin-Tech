...
const { checkAllTaxonomies }        = require('../../taxonomy/domain/taxonomy');
const { checkCovenant }             = require('../domain/covenant');
const { aggregatePortfolio }        = require('../domain/portfolio');
const { getEmissionSummary, get80PctMaterials, getMaterialBreakdown } = require('../../../platform/bridge/engine');
const { BUILDING_BENCHMARKS, TAXONOMY_ASEAN, PCAF_DATA_QUALITY } = require('../../../shared/constants');
