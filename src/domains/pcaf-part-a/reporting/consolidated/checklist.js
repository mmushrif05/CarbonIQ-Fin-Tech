...
const ITEMS = [
  ...
  {
    id: 'COV-1', group: 'Coverage', clause: 'Part A ch.6 (p.161); DCL p.124', duty: SHALL, section: 'annexFinanced',
  ...
  {
    id: 'GAS-1', group: 'Gases and units', clause: 'Part A ch.6 (p.163)', duty: SHALL, section: 'annexBasis',
  ...
  {
    id: 'ABS-1', group: 'Absolute emissions', clause: 'Part A ch.6 (p.163)', duty: SHALL, section: 'annexFinanced',
  ...
  {
    id: 'ABS-2', group: 'Absolute emissions', clause: 'Part A p.126', duty: SHALL, section: 'annexFinanced',
  ...
  {
    id: 'ABS-3', group: 'Absolute emissions', clause: 'Part A ch.6 (p.163); Annex 10.2', duty: SHALL, section: 'annexFinanced',
  ...
  {
    id: 'MTH-1', group: 'Methodology', clause: 'Part A §5.2 (p.57); §5.9 (p.144)', duty: SHALL, section: 'annexBasis',
  ...
  {
    id: 'DQ-1', group: 'Data quality', clause: 'Part A DCL p.128; Box 6.1-6', duty: SHALL, section: 'annexBasis',
  ...
  {
    id: 'REC-1', group: 'Recalculation', clause: 'Part A ch.6 (p.164)', duty: SHALL, section: 'annexBasis',
  ...
  {
    id: 'UNC-1', group: 'Uncertainty', clause: 'ISO 14064-3 §6.1.5; Part A ch.6 (p.167)', duty: SHOULD, section: 'annexBasis',
  ...
  {
    id: 'INT-1', group: 'Intensity', clause: 'Part A ch.6 (p.166); DCL p.127', duty: SHOULD, section: 'annexFinanced',
