...
const assessRouter = require('../../domains/lending/interface/routes/assess');
const projectsRouter = require('../../domains/lending/interface/routes/projects');
const scoreRouter = require('../../domains/lending/interface/routes/score');
const taxonomyRouter = require('../../domains/taxonomy/interface/routes/taxonomy');
...
const agentRouter         = require('../../domains/lending/interface/routes/agent');
const supervisorRouter    = require('../../domains/lending/interface/routes/supervisor');
const reportsRouter       = require('../../domains/lending/interface/routes/reports');
...
const pcafPartAFinanced   = require('../../domains/pcaf-part-a/interface/routes/consolidated');
...
router.use('/pcaf/part-a', pcafPartAFinanced);
