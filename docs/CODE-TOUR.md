...
|       `src/domains/capital/domain/` | 8 | 1,409 |
...
|       `src/domains/gcf/application/` | 5 | 1,726 |
|       `src/domains/gcf/domain/` | 18 | 4,289 |
|       `src/domains/gcf/infrastructure/` | 1 | 294 |
|         `src/domains/gcf/interface/routes/` | 1 | 24 |
|           `src/domains/gcf/interface/routes/gcf/` | 7 | 1,096 |
...
|       `src/domains/lending/domain/` | 8 | 1,117 |
|       `src/domains/lending/infrastructure/` | 1 | 94 |
|         `src/domains/lending/interface/routes/` | 14 | 1,956 |
|           `src/domains/lending/interface/routes/agent/` | 5 | 1,047 |
|         `src/domains/lending/interface/schemas/` | 12 | 718 |
...
|       `src/domains/pcaf-part-c/domain/` | 19 | 3,071 |
|         `src/domains/pcaf-part-c/interface/routes/` | 2 | 319 |
|           `src/domains/pcaf-part-c/interface/routes/partc-registry/` | 4 | 640 |
|           `src/domains/pcaf-part-c/interface/routes/pcaf-partc/` | 3 | 468 |
|         `src/domains/pcaf-part-c/interface/schemas/` | 4 | 471 |
|       `src/domains/pcaf-part-c/reporting/` | 5 | 585 |
|         `src/domains/pcaf-part-c/reporting/report-standard/` | 4 | 1,113 |
|       `src/domains/taxonomy/application/` | 1 | 229 |
|       `src/domains/taxonomy/domain/` | 4 | 932 |
|         `src/domains/taxonomy/interface/routes/` | 4 | 443 |
|         `src/domains/taxonomy/interface/schemas/` | 3 | 142 |
|     `src/platform/ai/` | 5 | 913 |
|     `src/platform/auth/` | 12 | 2,226 |
|     `src/platform/bridge/` | 2 | 367 |
|     `src/platform/config/` | 3 | 509 |
|     `src/platform/database/` | 10 | 1,889 |
|       `src/platform/database/adapters/` | 6 | 496 |
|     `src/platform/http/` | 22 | 2,617 |
