...
Checked across all three: **393**. Remaining: **210**.
...
Checked: **342**. Remaining: **67** (385 errors, measured by
...
Checked: **8**. Remaining: **25** (1698 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).
...
Checked: **43**. Remaining: **118** (1418 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).
