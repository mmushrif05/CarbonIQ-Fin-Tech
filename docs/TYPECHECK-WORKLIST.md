...
Checked across all three: **399**. Remaining: **213**.
...
Checked: **347**. Remaining: **67** (385 errors, measured by
...
Checked: **8**. Remaining: **25** (1707 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).
...
Checked: **44**. Remaining: **121** (1441 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).
