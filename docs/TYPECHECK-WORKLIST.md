...
Checked across all three: **420**. Remaining: **226**.
...
Checked: **367**. Remaining: **68** (406 errors, measured by
...
Checked: **8**. Remaining: **29** (1789 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).
...
Checked: **45**. Remaining: **129** (1489 errors, measured by
adopting the pragma on all of them at once and running this tree's own check).

**12 of them raise no errors at all** and can be adopted by adding the
pragma and nothing else.
...
| `tests/parta-climate-facts.test.js` | 15 |
...
| `tests/api.test.js` | 6 |
| `tests/gcf-record-script.test.js` | 6 |
