...
| `docs/PCAF-PART-A-RESEARCH.md` | The Third Edition studied category by category: the ten asset classes, the consolidated data-quality matrix, Chapter 6, the supplement, the gaps the standard leaves, how banks disclose today, what is built, and the build order |
