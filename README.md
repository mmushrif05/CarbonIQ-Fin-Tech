...
At the time of writing: 134 suites, 2,717 tests on PostgreSQL.
...
_190 operations across 158 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
