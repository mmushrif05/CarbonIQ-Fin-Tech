...
At the time of writing: 129 suites, 2,652 tests on PostgreSQL.
...
_183 operations across 152 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
