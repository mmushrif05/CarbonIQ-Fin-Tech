...
At the time of writing: 156 suites, 3,015 tests on PostgreSQL.
...
_218 operations across 180 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
