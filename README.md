...
At the time of writing: 146 suites, 2,912 tests on PostgreSQL.
...
_210 operations across 174 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
