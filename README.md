...
At the time of writing: 150 suites, 2,949 tests on PostgreSQL.
...
_213 operations across 176 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
