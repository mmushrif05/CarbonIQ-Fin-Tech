...
At the time of writing: 130 suites, 2,685 tests on PostgreSQL.
...
_186 operations across 155 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
