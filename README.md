...
At the time of writing: 152 suites, 2,975 tests on PostgreSQL.
...
_216 operations across 178 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
