...
At the time of writing: 141 suites, 2,789 tests on PostgreSQL.
...
_201 operations across 166 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
