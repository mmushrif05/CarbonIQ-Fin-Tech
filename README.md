...
At the time of writing: 157 suites, 3,033 tests on PostgreSQL.
...
_220 operations across 182 paths. Generated from `docs/openapi.json`, which is itself generated from the router — so a route that is not here does not exist. `docs/API-SCOPES.md` has the scope each one requires._
